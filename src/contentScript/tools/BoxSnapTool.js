...
class BoxSnapTool extends LitElement {
  ...
  connectedCallback() {
    ...
    this.debouncedOnPointerOverCallback =
      this._debouncedOnPointerOver.bind(this);
    this.onPointerOutCallback = this._onPointerOut.bind(this);
    this.onPointerDownCallback = this._onPointerDown.bind(this);
    this.onClickCallback = this._onClick.bind(this);
    ...
    document.addEventListener('click', this.onClickCallback, { capture: true });
  }
